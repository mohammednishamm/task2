    ...
    <Parallax ref={parallax} pages={3} horizontal>
      ...
      <ParallaxLayer offset={2} speed={1} style={{ backgroundColor: '#87BCDE' }} />
        ...
        >
         ...
         <div className='save'>
         <p style={{fontSize:"28px",paddingLeft:"10px",fontFamily:"cursive"}}>"SAVE WATER , SAVE LIFE"</p>
         <nav>
  <ul>
    <li>
      home
    ...
    <li>
      ...
      <span></span><span></span><span></span><span></span>
        ...
        >
          <img src='https://img.freepik.com/premium-vector/save-water-concept-life_42053-205.jpg?size=626&ext=jpg&ga=GA1.1.1844004614.1694415641&semt=ais' style={{ width: '40%',borderRadius:"360px" }} alt="Bash" />
          <nav>
  <ul>
    <li className="find-solution">
      ...
      <span></span><span></span><span></span><span></span>
        ...
        >
          <img src="https://img.freepik.com/free-vector/flat-illustration-world-water-day_23-2150147199.jpg?size=626&ext=jpg&ga=GA1.1.1844004614.1694415641&semt=ais" style={{ width: '40%',borderRadius:"360px" }} alt="Clients Main" />
          <nav>
  <ul>
    <li className="find-solution">
      Find Solutions
